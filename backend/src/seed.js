...
const MONGODB_URI =
  process.env.MONGODB_URI || "mongodb://127.0.0.1:27017/ravssinternational";

async function seed() {
  await mongoose.connect(MONGODB_URI);
  console.log("Seeding ravssinternational DB...");
  ...
  await Product.insertMany([
    { title: "Modern Gate", image: "https://res.cloudinary.com/dlxjb5vzm/image/upload/v1774166511/tptpfkugtinn82fmdjt9.png", category: gatesId, hidden: false },
    { title: "Classic Wrought Iron Gate", image: "https://images.unsplash.com/photo-1597003676818-8f1d5f1c3c14?w=600&h=450&fit=crop", category: gatesId, hidden: false },
    { title: "Steel Staircase", image: "https://images.unsplash.com/photo-1600585154340-be6161a56a0c?w=600&h=450&fit=crop", category: stairsId, hidden: false },
    { title: "Floating Tread Stairs", image: "https://images.unsplash.com/photo-1600566752227-8f3b8de1f8dd?w=600&h=450&fit=crop", category: stairsId, hidden: false },
  ]);
